...
mtr::Matrix CameraProjection::getProjectionMatrix(ProjectionType projectionType) const noexcept
{
    switch (projectionType) {
    case ProjectionType::Orthographic:
        return mtr::OrthographicProjection{width, height, zNear, zFar};
    case ProjectionType::Perspective:
        return mtr::PerspectiveProjectionWithAngle{degreeToRadian(angle), width/height, zNear, zFar};
    }
